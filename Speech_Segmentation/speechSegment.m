% This program segments continuous speech into word/sub-words
% using ALgorithm-4 (feature-based algorithm).
...
plot(t2, E); 
legend('FilteredShortTimeEnergy');
xlabel('Time in seconds');
ylabel('Energy');
...
plot(t2, C); 
legend('FilteredSpectralCentroid');
xlabel('Time in seconds');
...
%     ylabel('Amplitude');
    ...
    filename1 = [FileName 'S' num2str(i) '.wav'];
